...
function FAQItem({ question, answer }: { question: string; answer: string }) {
  ...
  return (
    <button
      ...
      className={`w-full text-left bg-slate-900 border ${isOpen ? 'border-purple-600/50' : 'border-white/10'} rounded-2xl p-6 hover:border-pink-500/30 transition-all duration-300 group`}
    >
      <div className="flex justify-between items-center gap-4">
        ...
        <ChevronDown className={`w-6 h-6 flex-shrink-0 transition-transform duration-300 ${isOpen ? 'rotate-180 text-purple-600' : 'text-white/30 group-hover:text-pink-500/50'}`} />
      </div>
      <div 
        className={`overflow-hidden transition-all duration-300 ${isOpen ? 'max-h-96 mt-4 opacity-100' : 'max-h-0 opacity-0'}`}
      >
        <p className="text-white/70 leading-relaxed pl-10 md:pl-12 border-l-2 border-purple-600/30 ml-2 py-2">
          {answer}
        </p>
      </div>
    </button>
    ...
    <FadeIn>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeInStagger className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {[
            ...
            return (
              <FadeInItem key={idx} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-purple-600/30 hover:bg-white/10 transition-all group">
                <div className="w-12 h-12 rounded-xl bg-gradient-to-r from-pink-500/10 via-purple-600/10 to-blue-600/10 flex items-center justify-center mb-4 group-hover:from-pink-500/20 group-hover:via-purple-600/20 group-hover:to-blue-600/20 transition-colors">
            ...
            <table className="w-full border-collapse">
              <thead>
                <tr className="border-b border-white/10">
                  ...
                  <th className="text-center p-4 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 font-bold text-lg">3 Months</th>
                  <th className="text-center p-4 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 font-bold text-lg bg-gradient-to-br from-purple-600/10 to-transparent">12 Months</th>
                  <th className="text-center p-4 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 font-bold text-lg">6 Months</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-white/5">
                {[
                  ...
                  <tr key={idx} className="hover:bg-white/5 transition-colors">
                    ...
                    <td className="p-4 text-center text-purple-600 font-medium bg-gradient-to-br from-purple-600/5 to-transparent">{row.pro}</td>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <FadeInStagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          <FadeInItem className="flex flex-col items-center text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-pink-500/30 transition-all hover:-translate-y-1">
            <div className="w-16 h-16 rounded-xl bg-gradient-to-r from-pink-500/10 via-purple-600/10 to-blue-600/10 flex items-center justify-center mb-4">
      ...
      <section className="py-16 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-pink-500/10 via-purple-600/10 to-blue-600/10 border border-purple-600/20 rounded-2xl p-8 md:p-10 text-center">
          <div className="inline-flex items-center gap-2 bg-purple-600/20 px-4 py-2 rounded-full border border-purple-600/30 mb-4">
            ...
            <span className="text-purple-600 font-bold text-xs uppercase tracking-wider">Risk-Free</span>
          </div>
      ...
      <div className="w-full max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 pb-24 relative">
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-2xl h-96 bg-purple-600/5 blur-[120px] rounded-full pointer-events-none"></div>
          ...
          <FadeIn>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link
                ...
                className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 text-white font-black uppercase tracking-widest text-sm hover:opacity-90 hover:scale-105 transition-all shadow-[0_0_30px_rgba(139,92,246,0.3)]"
              >
                Choose Your Plan
              </Link>
              <Link
            ...
            <div className="flex flex-wrap justify-center gap-6 mt-8 text-white/40 text-xs">
              <span className="flex items-center gap-2"><Zap className="w-3.5 h-3.5 text-pink-500/60" /> Instant Activation</span>
              <span className="flex items-center gap-2"><Lock className="w-3.5 h-3.5 text-purple-600/60" /> Secure Checkout</span>
              <span className="flex items-center gap-2"><CreditCard className="w-3.5 h-3.5 text-blue-600/60" /> All Major Cards</span>
            </div>
          </FadeIn>
        </div>
      </section>
