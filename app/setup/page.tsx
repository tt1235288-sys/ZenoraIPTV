            ...
            <div className="flex flex-wrap items-center justify-between gap-4 mb-4">
              <div className="flex items-center gap-3">
                ...
                <h3 className={`text-xl md:text-2xl font-bold transition-colors duration-300 ${
                  isInView ? 'text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600' : 'text-white'
                }`}>
                  {step.title}
                </h3>
              </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-6">
          {devices.map((device) => {
            ...
            return (
              ...
              >
                {device.popular && (
                  <div className="absolute -top-3 left-1/2 -translate-x-1/2 bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 text-white font-bold uppercase text-[10px] px-3 py-1 rounded-full whitespace-nowrap flex items-center gap-1">
