      ...
      <div className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4 py-24 text-center">
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-2xl mx-auto mb-12">
            <Link
              href="/"
              className="group flex flex-col items-center gap-2 p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-pink-500/30 hover:bg-pink-500/5 transition-all duration-300"
            >
              <Home className="w-5 h-5 text-pink-500 group-hover:scale-110 transition-transform" />
              <span className="text-white/70 text-xs font-bold uppercase tracking-wider">Home</span>
            </Link>
            
            <Link
              href="/pricing"
              className="group flex flex-col items-center gap-2 p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-purple-600/30 hover:bg-purple-600/5 transition-all duration-300"
            >
              <Tv className="w-5 h-5 text-purple-600 group-hover:scale-110 transition-transform" />
              <span className="text-white/70 text-xs font-bold uppercase tracking-wider">Pricing</span>
            </Link>
            
            <Link
              href="/setup"
              className="group flex flex-col items-center gap-2 p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-blue-600/30 hover:bg-blue-600/5 transition-all duration-300"
            >
              <Film className="w-5 h-5 text-blue-600 group-hover:scale-110 transition-transform" />
            ...
            <Link
              ...
              className="group flex flex-col items-center gap-2 p-4 rounded-2xl bg-white/5 border border-white/10 hover:border-pink-500/30 hover:bg-pink-500/5 transition-all duration-300"
            >
              <Search className="w-5 h-5 text-pink-500 group-hover:scale-110 transition-transform" />
