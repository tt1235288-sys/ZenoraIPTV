      ...
      <section className="relative pt-32 pb-16 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-500/10 via-purple-600/10 to-blue-600/10 backdrop-blur-sm px-4 py-2 rounded-full border border-purple-600/20 mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 font-bold text-sm uppercase tracking-wider">Your Privacy Matters</span>
          </div>
          ...
          <div className="flex gap-4">
            ...
            <div>
              <p className="text-white/80 text-sm leading-relaxed">
                <strong className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600">Our Commitment:</strong> We are committed to protecting your personal information and being transparent about how we handle your data.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="prose prose-invert prose-purple max-w-none">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-white/70 text-sm leading-relaxed">
                  <strong className="text-purple-600">What We Do NOT Collect:</strong> We do not track your specific viewing habits, 
          ...
          <ul className="space-y-2 mb-8">
            <li className="flex items-center gap-3 text-white/70">
              ...
              <span>Email: <a href={`mailto:privacy@${CONSTANTS.DOMAIN}`} className="text-purple-600 hover:text-pink-500 transition-colors">privacy@{CONSTANTS.DOMAIN}</a></span>
            </li>
          </ul>
        </div>
