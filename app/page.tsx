...
const PricingSection = dynamic(() => import('./components/PricingSection'), {
  loading: () => <div className="min-h-[600px] flex items-center justify-center"><div className="h-12 w-12 animate-spin rounded-full border-4 border-pink-500 border-t-transparent" /></div>,
});
...
const FAQ = dynamic(() => import('./components/FAQ'), {
  loading: () => <div className="min-h-[400px] flex items-center justify-center"><div className="h-12 w-12 animate-spin rounded-full border-4 border-pink-500 border-t-transparent" /></div>,
});
    ...
    <div className="flex flex-col min-h-screen bg-slate-950 overflow-hidden">
      ...
      <section className="relative px-6 pt-32 pb-24 md:pt-48 md:pb-32 overflow-hidden flex flex-col items-center justify-center text-center min-h-[90vh]">
        <div className="absolute inset-0 z-0">
          ...
          <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_var(--tw-gradient-stops))] from-pink-500/15 via-transparent to-transparent pointer-events-none" />
        </div>
        ...
        <FadeIn className="relative z-10 max-w-5xl mx-auto flex flex-col items-center">
          <div className="inline-flex items-center gap-2 bg-pink-500/10 backdrop-blur-sm px-4 py-2 rounded-full border border-pink-500/20 mb-6">
            ...
            <span className="text-pink-500 font-bold text-sm uppercase tracking-wider">#1 Rated IPTV Service 2026</span>
          </div>
          ...
          <p className="text-lg md:text-2xl text-white/80 max-w-3xl mb-6 font-medium drop-shadow-md leading-relaxed">
            Welcome to <strong className="text-pink-500">{CONSTANTS.FOCUS_KEYWORD}</strong> - The most reliable premium IPTV provider with 15,000+ live channels, 60,000+ VODs, and crystal-clear 4K streaming. Experience the best IPTV subscription for sports, movies, and entertainment.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 items-center justify-center w-full">
            <Link href="/pricing" className="w-full sm:w-auto px-8 py-4 rounded-full bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 text-white font-black text-lg hover:scale-105 transition-all shadow-[0_0_30px_rgba(236,72,153,0.3)]">
              Get Started Now
            </Link>
          ...
          <div className="mt-16 flex flex-wrap justify-center gap-8 text-sm text-pink-500 font-bold uppercase tracking-widest backdrop-blur-sm bg-white/5 px-8 py-4 rounded-3xl border border-white/10">
      ...
      <section className="py-32 bg-gradient-to-b from-slate-900 to-slate-950 border-y border-white/5 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-full h-full bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-pink-500/10 via-transparent to-transparent pointer-events-none" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeIn>
            <div className="flex flex-col items-center justify-center text-center max-w-3xl mx-auto mb-20">
               <span className="text-pink-500 font-bold uppercase tracking-widest text-sm mb-4">Quick Start Guide</span>
          ...
          <FadeInStagger className="grid grid-cols-1 md:grid-cols-3 gap-12 relative">
            ...
            <FadeInItem className="relative flex flex-col items-center text-center z-10 group">
              <div className="w-24 h-24 rounded-[2rem] bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-white/10 flex items-center justify-center mb-8 group-hover:border-pink-500/50 group-hover:-translate-y-2 transition-all duration-300 shadow-xl relative backdrop-blur-sm">
                <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white font-black flex items-center justify-center text-sm shadow-lg">1</div>
            ...
            <FadeInItem className="relative flex flex-col items-center text-center z-10 group">
              <div className="absolute inset-0 bg-pink-500/10 blur-3xl rounded-[3rem] group-hover:bg-pink-500/20 transition-all duration-500" />
              <div className="w-28 h-28 rounded-[2.5rem] bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-pink-500 shadow-[0_0_30px_rgba(236,72,153,0.2)] flex items-center justify-center mb-8 relative z-10 group-hover:scale-110 transition-transform duration-500 backdrop-blur-sm">
                <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white font-black flex items-center justify-center text-sm shadow-lg">2</div>
                <Download className="w-12 h-12 text-pink-500 relative z-10" />
              </div>
            ...
            <FadeInItem className="relative flex flex-col items-center text-center z-10 group">
              <div className="w-24 h-24 rounded-[2rem] bg-gradient-to-br from-slate-800 to-slate-900 border-2 border-white/10 flex items-center justify-center mb-8 group-hover:border-pink-500/50 group-hover:-translate-y-2 transition-all duration-300 shadow-xl relative backdrop-blur-sm">
                <div className="absolute -top-3 -right-3 w-8 h-8 rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white font-black flex items-center justify-center text-sm shadow-lg">3</div>
                <Tv2 className="w-10 h-10 text-white/50 group-hover:text-pink-500 transition-colors" />
              </div>
      ...
      <section className="py-24 bg-slate-900 rounded-[3rem] mx-4 sm:mx-8 mb-24 border border-white/5 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeIn className="text-center mb-12">
            <div className="text-4xl md:text-5xl font-black text-white mb-4 uppercase tracking-tight"><span className="text-pink-500">{CONSTANTS.FOCUS_KEYWORD}</span> By The Numbers</div>
          ...
          <FadeInStagger className="grid grid-cols-2 md:grid-cols-4 gap-8 md:gap-12 text-center">
            <FadeInItem className="flex flex-col items-center">
              ...
              <span className="text-sm text-pink-500 font-bold uppercase tracking-widest mt-2">Happy Subscribers</span>
            ...
            <FadeInItem className="flex flex-col items-center">
              ...
              <span className="text-sm text-pink-500 font-bold uppercase tracking-widest mt-2">Live Channels</span>
            ...
            <FadeInItem className="flex flex-col items-center">
              ...
              <span className="text-sm text-pink-500 font-bold uppercase tracking-widest mt-2">Movies & Series</span>
            ...
            <FadeInItem className="flex flex-col items-center">
              ...
              <span className="text-sm text-pink-500 font-bold uppercase tracking-widest mt-2">Server Uptime</span>
      ...
      <section id="channels" className="py-24 max-w-[100vw] overflow-hidden relative min-h-[400px]">
        ...
        <FadeIn className="px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto flex flex-col justify-between items-start mb-12 gap-6 relative z-10 w-full">
          <div>
            <h2 className="text-4xl md:text-5xl font-black text-white mb-4 uppercase tracking-tight"><span className="text-pink-500">PREMIUM</span> CONTENT LIBRARY</h2>
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-gradient-to-r from-pink-500/10 via-transparent to-purple-600/10 backdrop-blur-sm border border-pink-500/20 rounded-3xl p-8 md:p-12">
          <FadeInStagger className="flex flex-col md:flex-row justify-between items-center gap-8 text-center md:text-left">
            ...
            <FadeInItem className="flex items-center gap-4">
              <div className="w-16 h-16 rounded-full bg-orange-500/20 flex items-center justify-center shrink-0">
                <LifeBuoy className="w-8 h-8 text-orange-500" />
              </div>
              <div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="absolute inset-0 opacity-30 pointer-events-none" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='30' height='30' viewBox='0 0 30 30' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h30v30H0z' fill='none'/%3E%3Ccircle cx='15' cy='15' r='1' fill='%23ec4899' fill-opacity='0.3'/%3E%3C/svg%3E")` }} />
        <FadeIn className="text-center mb-16 relative z-10">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight">Why <span className="text-pink-500">{CONSTANTS.FOCUS_KEYWORD}</span> Is The Best IPTV Choice</h2>
          ...
          {[
            ...
            return (
              <FadeInItem key={idx} className="bg-gradient-to-br from-slate-900/80 to-slate-950/80 backdrop-blur-sm border border-white/5 rounded-2xl p-8 hover:border-pink-500/30 hover:bg-white/5 transition-all group">
                <div className="w-14 h-14 rounded-xl bg-gradient-to-r from-pink-500/10 to-purple-600/10 flex items-center justify-center mb-6 group-hover:from-pink-500/20 group-hover:to-purple-600/20 transition-colors">
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-12">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight">Channel <span className="text-pink-500">Categories</span></h2>
            ...
            return (
              <FadeInItem key={idx} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-xl p-4 hover:border-pink-500/30 hover:bg-white/10 transition-all">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <h3 className="font-bold text-pink-500 text-sm sm:text-base">{item.cat}</h3>
                </div>
        ...
        <div className="relative z-10 mx-auto max-w-7xl space-y-24 px-4 sm:px-6 lg:space-y-32 lg:px-8">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
              ...
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl sm:aspect-video lg:aspect-[5/4]">
                ...
                <div className="absolute bottom-4 left-4 right-4 rounded-2xl border border-white/10 bg-black/70 p-4 backdrop-blur-xl sm:bottom-6 sm:left-6 sm:right-auto sm:max-w-[320px]">
                  <div className="flex items-center gap-3">
                    <span className="flex h-11 w-11 items-center justify-center rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white shrink-0">
            ...
            <FadeIn className="order-2">
              ...
              <h3 className="text-3xl font-black uppercase leading-tight tracking-tight text-white sm:text-4xl md:text-5xl">
                Experience Premium <span className="block bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 bg-clip-text text-transparent">4K Streaming Quality</span>
              </h3>
              ...
              <div className="mt-7 grid grid-cols-1 gap-3 sm:grid-cols-2">
                {['HD, Full HD & 4K channels', 'Smooth anti-freeze streaming', 'Movies and series on demand', 'Works on Smart TV, Android, iOS & Firestick'].map((item) => (
              ...
              <Link href="/pricing" className="mt-8 inline-flex rounded-full bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 px-8 py-4 text-sm font-black uppercase tracking-widest text-white shadow-xl transition hover:scale-105">
          ...
          <div className="grid items-center gap-10 lg:grid-cols-2 lg:gap-16">
            <FadeIn className="order-2 lg:order-1">
              ...
              <h3 className="text-3xl font-black uppercase leading-tight tracking-tight text-white sm:text-4xl md:text-5xl">
                Never Miss The <span className="block bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 bg-clip-text text-transparent">Biggest Live Events</span>
              </h3>
              <p className="mt-6 text-base leading-relaxed text-white/65 sm:text-lg">
              ...
              <div className="mt-7 grid grid-cols-1 gap-3 sm:grid-cols-2">
                {['Live football and global leagues', 'Boxing, UFC and PPV events', 'Premium sports channels', 'Low-latency streaming experience'].map((item) => (
                  <div key={item} className="rounded-2xl border border-white/10 bg-white/[0.04] px-4 py-3 text-sm font-semibold text-white/75">✓ {item}</div>
                ))}
              </div>
              <Link href="/pricing" className="mt-8 inline-flex rounded-full border-2 border-pink-500 px-8 py-4 text-sm font-black uppercase tracking-widest text-pink-500 transition hover:scale-105 hover:bg-gradient-to-r hover:from-pink-500 hover:to-purple-600 hover:text-white">
                Explore Sports Packages
              </Link>
            </FadeIn>
            <div className="relative order-1 overflow-hidden rounded-3xl border border-pink-500/20 bg-white/[0.03] p-3 shadow-[0_0_60px_rgba(236,72,153,0.08)] lg:order-2 lg:rounded-[2.5rem]">
              <div className="relative aspect-[4/3] overflow-hidden rounded-2xl sm:aspect-video lg:aspect-[5/4]">
                <Image
                  src="/img/bg-1.webp"
                ...
                <div className="absolute bottom-4 left-4 right-4 rounded-2xl border border-white/10 bg-black/70 p-4 backdrop-blur-xl sm:bottom-6 sm:left-6 sm:right-6">
                  <div className="flex items-center gap-4">
                    <span className="flex h-12 w-12 shrink-0 items-center justify-center rounded-full bg-gradient-to-r from-pink-500 to-purple-600 text-white shadow-[0_0_25px_rgba(236,72,153,0.7)]">
                      <Trophy className="h-6 w-6" />
                    </span>
                    <div>
                      <p className="text-lg font-black uppercase text-white sm:text-2xl">Live VIP Sports</p>
                      <p className="text-xs font-bold uppercase tracking-widest text-pink-500">Premium IPTV Sports Channels</p>
                    </div>
                  </div>
                </div>
              </div>
      ...
      <section className="py-24 relative overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-b from-pink-500/5 via-transparent to-purple-600/5" />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <FadeIn className="text-center mb-12">
          ...
          <div className="hidden md:block overflow-x-auto">
            <div className="bg-gradient-to-br from-slate-900/80 to-slate-950/80 backdrop-blur-sm rounded-3xl border border-white/10 overflow-hidden">
              <div className="grid grid-cols-3 gap-0">
                ...
                <div className="p-6 border-b border-r border-white/10 bg-gradient-to-r from-pink-500/10 to-purple-600/10"><h3 className="text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600">{CONSTANTS.FOCUS_KEYWORD}</h3></div>
                ...
                {[
                  ...
                  { feature: "Contract Required", us: "No contract", cable: "12-24 month commitment", usIcon: true },
                  ...
                  { feature: "4K Streaming", us: "Yes", cable: "Rarely", usIcon: true },
                  { feature: "Multi-device Support", us: "Unlimited devices", cable: "Extra fees per TV", usIcon: true },
                  { feature: "Sports PPV Included", us: "All included", cable: "Extra $50-$100 per event", usIcon: true },
                  ...
                  <div key={idx} className="grid grid-cols-3 gap-0 contents">
                    ...
                    <div className={`p-6 border-r border-white/5 ${idx % 2 === 0 ? 'bg-white/5' : ''}`}>
                      {row.usIcon ? (
                        <div className="flex items-center gap-2"><CheckCircle2 className="w-5 h-5 text-pink-500" /><span className="text-pink-500">{row.us}</span></div>
                      ) : (
            ...
            {[
              ...
              <div key={idx} className="bg-gradient-to-br from-slate-900/80 to-slate-950/80 backdrop-blur-sm rounded-2xl border border-white/10 p-6">
                ...
                <div className="flex justify-between items-center">
                  <div className="text-left"><div className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 font-bold text-lg">{row.us}</div><div className="text-pink-500/60 text-xs">{CONSTANTS.FOCUS_KEYWORD}</div></div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <FadeIn className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-white mb-6 uppercase tracking-tight">Trusted by <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600">20,000+</span> Customers</h2>
          ...
          {[
            ...
            <FadeInItem key={idx} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-pink-500/30 transition-all">
              <div className="flex gap-1 mb-4">
                {[...Array(testimonial.rating)].map((_, i) => <Star key={i} className="w-5 h-5 fill-pink-500 text-pink-500" />)}
              </div>
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center w-full relative">
        <div className="absolute inset-0 opacity-5" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='40' height='40' viewBox='0 0 40 40' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M0 0h40v40H0z' fill='none'/%3E%3Crect x='18' y='18' width='4' height='4' fill='%23ec4899'/%3E%3C/svg%3E")` }} />
          ...
          {[
            ...
            return (
              <FadeInItem key={device.tag} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-3xl p-6 flex flex-col items-center justify-center gap-4 hover:border-pink-500/50 hover:bg-white/10 hover:-translate-y-2 transition-all cursor-pointer group">
                <Icon className="w-12 h-12 text-white/30 group-hover:text-pink-500 group-hover:scale-110 transition-all" />
      ...
      <section className="py-24 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative">
        <div className="absolute inset-0 opacity-30 pointer-events-none" style={{ backgroundImage: `url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M30 0 L60 30 L30 60 L0 30 Z' fill='none' stroke='%23ec4899' stroke-width='0.5' stroke-opacity='0.1'/%3E%3C/svg%3E")` }} />
        
        <FadeIn className="flex flex-col md:flex-row justify-between items-end mb-12 gap-6 relative z-10">
          <div>
            <h2 className="text-3xl md:text-5xl font-black text-white mb-4 uppercase tracking-tight">Latest <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600">News & Guides</span></h2>
          ...
          {blogPosts.slice(0, 3).map((post) => (
            <FadeInItem key={post.id} className="group cursor-pointer">
              <Link href={`/blog/${post.slug}`} className="block">
                <div className="relative aspect-video rounded-3xl overflow-hidden mb-6 bg-slate-900 border border-white/10 shadow-lg group-hover:border-pink-500/30 transition-colors duration-300">
                  <Image 
                    src={post.image} 
                  ...
                  <div className="absolute bottom-6 left-6">
                    <span className="px-3 py-1 bg-gradient-to-r from-pink-500 to-purple-600 text-white text-[10px] font-black uppercase tracking-widest rounded-lg inline-block">{post.author}</span>
                  </div>
                </div>
                <h3 className="text-xl md:text-2xl font-bold text-white mb-3 group-hover:text-pink-500 transition-colors tracking-tight line-clamp-2">{post.title}</h3>
                <p className="text-white/60 text-sm md:text-base mb-4 line-clamp-2 leading-relaxed">{post.excerpt}</p>
                <span className="inline-flex items-center gap-2 text-sm font-bold text-pink-500 uppercase tracking-widest group-hover:gap-3 transition-all">
        ...
        <div className="relative z-10 mx-auto max-w-7xl">
          <div className="relative overflow-hidden rounded-[2rem] border border-pink-500/20 bg-black shadow-[0_0_80px_rgba(236,72,153,0.08)] lg:rounded-[3rem]">
            ...
            <FadeIn className="relative z-10 px-6 py-14 text-center sm:px-10 sm:py-16 md:px-14 md:py-20 lg:px-20 lg:py-24">
              <div className="mb-6 inline-flex items-center gap-2 rounded-full border border-pink-500/30 bg-pink-500/10 px-4 py-2 backdrop-blur-md">
                <svg className="h-4 w-4 text-pink-500" fill="currentColor" viewBox="0 0 20 20"><path d="M10 2L13 7L18 8L14 12L15 18L10 15L5 18L6 12L2 8L7 7L10 2Z" /></svg>
                <span className="text-xs font-black uppercase tracking-[0.22em] text-pink-500">Premium IPTV Service</span>
              </div>
              <h2 className="mx-auto max-w-5xl text-3xl font-black uppercase leading-tight tracking-tight text-white sm:text-4xl md:text-5xl lg:text-6xl">
                Upgrade Your <span className="block bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 bg-clip-text text-transparent">Entertainment Experience</span>
              </h2>
              ...
              <div className="mx-auto mt-10 grid max-w-4xl grid-cols-2 gap-3 sm:gap-4 lg:grid-cols-4">
                {[
                  ...
                  <div key={label} className="rounded-2xl border border-white/10 bg-black/45 p-4 backdrop-blur-md">
                    <div className="text-2xl font-black text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 sm:text-3xl">{value}</div>
                    <div className="mt-1 text-[10px] font-bold uppercase tracking-widest text-white/55">{label}</div>
                  </div>
                ))}
              </div>
              <div className="mt-10 flex flex-col items-center justify-center gap-4 sm:flex-row">
                <Link href="/pricing" className="inline-flex w-full items-center justify-center rounded-full bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 px-10 py-4 text-sm font-black uppercase tracking-widest text-white shadow-[0_0_30px_rgba(236,72,153,0.35)] transition-all hover:scale-105 sm:w-auto">
