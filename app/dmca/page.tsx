      ...
      <section className="relative pt-32 pb-16 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-500/10 via-purple-600/10 to-blue-600/10 backdrop-blur-sm px-4 py-2 rounded-full border border-purple-600/20 mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 font-bold text-sm uppercase tracking-wider">Copyright Protection</span>
          </div>
      ...
      <div className="max-w-3xl mx-auto px-4 py-16">
        ...
        <div className="prose prose-invert prose-purple max-w-none">
          ...
          <div className="bg-slate-900/50 border border-white/10 rounded-2xl p-6 my-6 text-center">
            ...
            <a href={`mailto:dmca@${CONSTANTS.DOMAIN}`} className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 font-bold text-xl hover:from-pink-600 hover:via-purple-700 hover:to-blue-700 transition-colors">
          ...
          <ul className="space-y-2 mb-8">
            <li className="flex items-center gap-3 text-white/70">
              ...
              <span>Email: <a href={`mailto:dmca@${CONSTANTS.DOMAIN}`} className="text-purple-600 hover:text-pink-500 transition-colors">dmca@{CONSTANTS.DOMAIN}</a></span>
            </li>
          </ul>
        </div>
