...
export const metadata: Metadata = {
  title: `Blog & News | Zenora IPTV - IPTV Tips, Guides & Updates 2025`,
  description: `Read the latest articles, guides, and news about Zenora IPTV. Learn IPTV setup tips, channel updates, streaming optimization, and entertainment news.`,
  keywords: [
    'Zenora IPTV blog',
    'IPTV news',
    'streaming tips',
  ...
  openGraph: {
    title: `Zenora IPTV - Blog & News | IPTV Tips and Guides`,
    description: `Stay updated with the latest Zenora IPTV news, setup guides, channel updates, and streaming tips.`,
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: `Zenora IPTV Blog`,
      },
    ],
  },
  twitter: {
    card: 'summary_large_image',
    title: `Zenora IPTV - Blog & News`,
    description: `Latest IPTV tips, guides, and news from Zenora IPTV.`,
      ...
      <div className="flex flex-col min-h-screen bg-slate-950 px-6 py-24">
        <div className="max-w-7xl mx-auto text-center mb-16 relative">
          ...
          <h1 className="text-5xl md:text-7xl font-black text-white uppercase tracking-tight mb-6 mt-16 relative z-10">
            Zenora IPTV <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600">News</span>
          </h1>
          <p className="text-xl text-white/60 max-w-2xl mx-auto font-medium relative z-10">
            Stay updated with the latest tips, platform updates, and comprehensive guides for maximizing your Zenora IPTV subscription.
          </p>
        </div>
        ...
        <div className="max-w-7xl mx-auto w-full grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 relative z-10">
          {blogPosts.map((post) => (
            <Link href={`/blog/${post.slug}`} key={post.id} className="group rounded-[2rem] overflow-hidden transition-all duration-500 flex flex-col relative transform hover:-translate-y-2 isolate">
              ...
              <div className="absolute inset-0 rounded-[2rem] bg-gradient-to-b from-white/10 to-white/5 group-hover:from-purple-600/50 group-hover:to-blue-600/30 transition-colors duration-500 p-[1px] z-10">
              ...
              <div className="absolute top-6 left-6 z-30 flex flex-wrap gap-2">
                {post.keywords && post.keywords.slice(0, 2).map((kw: string) => (
                  <span key={kw} className="px-3 py-1.5 bg-white/5 backdrop-blur-md text-white/80 border border-white/10 text-[10px] font-black uppercase tracking-widest rounded-full shadow-sm group-hover:border-purple-600/30 group-hover:text-purple-600 transition-colors">
                    {kw}
                  </span>
                ))}
              </div>
              ...
              <div className="absolute inset-x-0 bottom-0 z-30 p-8 flex flex-col justify-end h-full">
                ...
                <div className="flex items-center gap-3 text-xs font-bold text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 mb-4 uppercase tracking-widest drop-shadow-md">
                  <div className="w-8 h-8 rounded-full bg-purple-600/20 flex items-center justify-center border border-purple-600/50 text-purple-600 flex-shrink-0 shadow-[0_0_10px_rgba(139,92,246,0.2)]">
                    {post.author[0]}
                  </div>
                ...
                <h3 className="text-2xl lg:text-3xl font-black text-white mb-3 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-pink-500 group-hover:via-purple-600 group-hover:to-blue-600 transition-all duration-300 leading-tight drop-shadow-lg">{post.title}</h3>
