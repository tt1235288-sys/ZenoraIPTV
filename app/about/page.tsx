  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-950">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden border-b border-white/5">
        <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-pink-500/10 via-purple-600/5 to-transparent pointer-events-none" />
      ...
      <section className="py-16 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
          {[
            ...
            <div key={idx} className="text-center p-6 bg-white/5 backdrop-blur-sm rounded-2xl border border-white/10 hover:border-purple-600/30 transition-all group">
              <stat.icon className="w-10 h-10 text-purple-600 mx-auto mb-3 group-hover:scale-110 transition-transform" />
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        {/* Introduction Box */}
        <div className="bg-purple-600/5 border border-purple-600/20 rounded-2xl p-6 mb-10">
        ...
        <div className="prose prose-invert prose-purple max-w-none">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 my-8">
            {[
              ...
              <div key={idx} className="flex gap-3 p-4 bg-white/5 rounded-xl border border-white/10 hover:border-purple-600/30 transition-all group">
                <item.icon className="w-8 h-8 text-purple-600 flex-shrink-0 group-hover:scale-110 transition-transform" />
                <div>
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-white/70 text-sm leading-relaxed">
                  <strong className="text-purple-600">Technical Excellence:</strong> Our servers are strategically located across North America, 
          ...
          <p className="text-white/70 leading-relaxed mb-6">
            With <strong className="text-purple-600">15,000+ live channels</strong> and <strong className="text-purple-600">60,000+ video-on-demand titles</strong>, 
        ...
        <div className="mt-12 pt-8 border-t border-white/10 text-center">
          <Link href="/" className="inline-flex items-center gap-2 text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 hover:from-pink-600 hover:via-purple-700 hover:to-blue-700 transition-colors">
            ← Back to Homepage
          </Link>
        </div>
      </div>
