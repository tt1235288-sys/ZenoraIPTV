      ...
      <section className="relative pt-32 pb-16 overflow-hidden border-b border-white/5">
        ...
        <div className="max-w-4xl mx-auto px-4 text-center relative z-10">
          <div className="inline-flex items-center gap-2 bg-gradient-to-r from-pink-500/10 via-purple-600/10 to-blue-600/10 backdrop-blur-sm px-4 py-2 rounded-full border border-purple-600/20 mb-6">
            ...
            <span className="text-transparent bg-clip-text bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 font-bold text-sm uppercase tracking-wider">Legal Agreement</span>
          </div>
        ...
        <div className="prose prose-invert prose-purple max-w-none">
            ...
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-white/70 text-sm leading-relaxed">
                  <strong className="text-purple-600">Account Responsibility:</strong> You are solely responsible for maintaining 
          ...
          <div className="bg-white/5 border border-white/10 rounded-2xl p-6 my-6">
            <div className="flex gap-4">
              ...
              <div>
                <p className="text-white/70 text-sm leading-relaxed">
                  <strong className="text-purple-600">Survival:</strong> Sections regarding intellectual property, warranty disclaimers, 
          ...
          <ul className="space-y-2 mb-8">
            <li className="flex items-center gap-3 text-white/70">
              ...
              <span>Email: <a href={`mailto:legal@${CONSTANTS.DOMAIN}`} className="text-purple-600 hover:text-pink-500 transition-colors">legal@{CONSTANTS.DOMAIN}</a></span>
            </li>
          </ul>
        </div>
