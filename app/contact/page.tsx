...
// Success Popup Modal - Updated to Zenora IPTV colors
const SuccessPopup = ({ onClose }: { onClose: () => void }) => {
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm animate-fade-in">
      <div className="bg-slate-900 border border-pink-500/30 rounded-3xl p-8 md:p-12 max-w-md w-full mx-4 shadow-2xl text-center animate-scale-up">
        ...
        <button
          onClick={onClose}
          className="w-full py-3 rounded-full bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 text-white font-black text-sm uppercase tracking-widest hover:opacity-90 transition-all"
        >
          Got It
        </button>
      </div>
...
export default function ContactPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 pt-32 pb-16">
      ...
      {/* Hero Section - Updated to Zenora IPTV colors */}
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          <FadeIn>
            <div className="inline-flex items-center gap-2 bg-pink-500/10 backdrop-blur-sm px-4 py-2 rounded-full border border-pink-500/20 mb-6">
              ...
              <span className="text-pink-500 font-bold text-sm uppercase tracking-wider">Get in Touch</span>
            </div>
            ...
            <p className="text-lg md:text-xl text-white/60 max-w-2xl mx-auto leading-relaxed">
              Have questions about {CONSTANTS.FOCUS_KEYWORD}? Need help with setup? Our support team is here to help you 24/7.
            </p>
          </FadeIn>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-gradient-to-br from-slate-900/80 to-slate-950/80 backdrop-blur-sm border border-white/10 rounded-3xl p-6 md:p-8 shadow-xl">
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-5">
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        required
                        className="w-full pl-12 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:border-pink-500/50 focus:ring-2 focus:ring-pink-500/20 transition-all outline-none"
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <select
                        ...
                        onChange={handleChange}
                        required
                        className="w-full pl-12 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:border-pink-500/50 focus:ring-2 focus:ring-pink-500/20 transition-all outline-none appearance-none"
                      >
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <textarea
                        ...
                        required
                        rows={5}
                        className="w-full pl-4 pr-4 py-3.5 bg-white/5 border border-white/10 rounded-xl text-white placeholder-white/30 focus:border-pink-500/50 focus:ring-2 focus:ring-pink-500/20 transition-all outline-none resize-none"
                  ...
                  <button
                    type="submit"
                    disabled={loading}
                    className={`w-full py-4 rounded-xl bg-gradient-to-r from-pink-500 via-purple-600 to-blue-600 text-white font-black text-sm uppercase tracking-widest transition-all flex items-center justify-center gap-3 ${
                      loading 
                        ? 'opacity-70 cursor-not-allowed' 
                        : 'hover:opacity-90 hover:scale-[1.02] shadow-[0_0_30px_rgba(236,72,153,0.2)]'
                    }`}
                  >
                    {loading ? (
                      <>
          ...
          {/* Contact Info - Updated to Zenora IPTV */}
              ...
              <div className="bg-gradient-to-br from-slate-900/80 to-slate-950/80 backdrop-blur-sm border border-white/10 rounded-3xl p-6 md:p-8 shadow-xl space-y-6">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <a href={`mailto:support@${CONSTANTS.DOMAIN}`} className="text-white hover:text-pink-500 transition-colors text-sm">
                      support@{CONSTANTS.DOMAIN}
                    </a>
                  </div>
                </div>
                
                <div className="flex items-start gap-4">
                  <div className="flex-shrink-0 w-12 h-12 rounded-xl bg-purple-600/10 flex items-center justify-center">
                    <Phone className="w-6 h-6 text-purple-600" />
                  </div>
                  <div>
                    <p className="text-white/40 text-xs uppercase tracking-wider font-bold">Phone</p>
                    <a href="tel:+447868196544" className="text-white hover:text-purple-600 transition-colors text-sm">
                      +44 7868 196544
                    </a>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <button className="text-pink-500 text-sm hover:text-pink-400 transition-colors font-medium mt-1">
                      Start Chat
                    </button>
                  </div>
                </div>
                ...
                <div className="pt-6 border-t border-white/10">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div className="bg-white/5 rounded-xl p-3 text-center">
                      <Headphones className="w-5 h-5 text-pink-500 mx-auto mb-1" />
      ...
      {/* Trust Badges Section - Updated to Zenora IPTV colors */}
      <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <FadeIn>
          <div className="bg-gradient-to-r from-pink-500/10 via-transparent to-purple-600/10 border border-pink-500/20 rounded-3xl p-8 md:p-10">
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-center">
              ...
              <div>
                <div className="w-12 h-12 rounded-xl bg-purple-600/10 flex items-center justify-center mx-auto mb-3">
      ...
      {/* FAQ Section - Updated to Zenora IPTV colors */}
      <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 mt-16">
        <FadeIn className="text-center mb-12">
          ...
          <p className="text-white/60 text-lg">Quick answers to common {CONSTANTS.FOCUS_KEYWORD} questions</p>
        </FadeIn>
        
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {[
            {
              q: `How do I contact ${CONSTANTS.FOCUS_KEYWORD} support?`,
              a: `You can reach us via email at support@${CONSTANTS.DOMAIN}, through our live chat, or by submitting the contact form above.`
            },
            {
              q: `How long does ${CONSTANTS.FOCUS_KEYWORD} take to respond?`,
            ...
            {
              q: `Does ${CONSTANTS.FOCUS_KEYWORD} offer technical support?`,
              a: `Yes, we provide full technical support for all ${CONSTANTS.FOCUS_KEYWORD} services. Our team can help with setup, troubleshooting, and any technical questions.`
            },
            {
              q: `Is there a phone number for ${CONSTANTS.FOCUS_KEYWORD}?`,
              a: `Yes, you can reach us at +44 7868 196544 for urgent inquiries about ${CONSTANTS.FOCUS_KEYWORD}.`
            }
          ].map((faq, idx) => (
            <div key={idx} className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-6 hover:border-pink-500/30 transition-all">
