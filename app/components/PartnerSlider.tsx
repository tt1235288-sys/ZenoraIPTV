...
export default function PartnerSlider() {
  // Generate partner images from 01 to 10
  const partners = Array.from({ length: 10 }, (_, i) => {
    ...
    return {
      ...
      imagePath: `/img/partners/zenoraiptv-icons-${partnerNumberPad}`,
  ...
  return (
    <div className="w-full overflow-hidden relative py-12 bg-black/50 border-y border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center mb-8">
        <p className="text-sm text-white/40 font-bold uppercase tracking-widest">{CONSTANTS.FOCUS_KEYWORD} • Trusted Partners & Ecosystems</p>
      </div>
