        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex">
              <Link href="/pricing" className="px-6 py-2.5 rounded-full bg-white/5 border border-white/10 text-white hover:bg-gradient-to-r hover:from-pink-500 hover:via-purple-600 hover:to-blue-600 hover:border-transparent hover:text-white font-bold tracking-widest uppercase text-sm transition-all shadow-lg">
                Get Started
              </Link>
            </div>
